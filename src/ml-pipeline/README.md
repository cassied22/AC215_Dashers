...
4. **Data Split**: We first save the last 1000 QA pairs for our customized evaluation metric which will be explained in the Model Evaluation section below. Then for the first 5000 pairs, we will use it for Vextex AI pipeline: We split it into training and test sets using a 90/10 split ratio, ensuring that 10% of the dataset was held out for testing.
