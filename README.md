...
We have set up a GitHub Action that will build and deploy a new version of the app on Google Kubernetes Engine (GKE) when a git commit has a comment containing `/deploy-app`. You can find an example snapshot below and please also refer to [Kubernetes documentation](src/deployment/README.md)
